...
%%
\fixme{need new circuit schematic elements}
\begin{table}
  \centering
...
\end{table}
%%
\fixme{need new circuit schematic}
\begin{figure}
  \centering
  \includegraphics[width=\textwidth/2]{figures/filament}
...
\begin{enumerate}
\item Measure and record the ambient temperature in the room.
\item Directly measure the resistance of each of your lamps.  Using
  the data in Table~\ref{tab:filament} you can determine the
  resistivity of tungsten.  Are your measurements consistent?  If not,
  why not?
...
\fixme{need new multimeter diagram}
\begin{figure}
  \centering
  \includegraphics[width=\textwidth/2]{figures/filament}
...
\item Most metals are \textit{ductile} as well as \textit{conductive};
  ...
  nichrome.\footnote{A steel-like alloy of nickel, chromium, and
    iron.}
\fixme{need calorimeter picture}
\begin{figure}
  \centering
  \includegraphics[width=\textwidth/2]{figures/filament}
