...
\begin{figure}
  \centering
  \subfloat[][Wavetek Signal Generator]{
    \label{fig:meters:siggen}
    \includegraphics[angle=90,width=\textwidth/3]{figures/wavetek-signal-generator}
% Photo by Trong Nguyen, York College CLT, 2012-02
  } \qquad
  \subfloat[][BK Precision Frequency Measuring Multimeter]{
    \label{fig:meters:freq}
    \includegraphics[width=\textwidth/3]{figures/bk_5460}
